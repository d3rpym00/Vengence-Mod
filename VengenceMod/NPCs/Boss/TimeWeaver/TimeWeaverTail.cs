...
{
	public class TimeWeaverTail : ModNPC
	{
		...
		public override void AI()
		{
			...
			int parent = NPC.FindFirstNPC(ModContent.NPCType<TimeWeaverHead>());
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			for (int k = 0; k < 5; k++)
			{
				...
				if (npc.life <= 0)
				{
					...
					Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gore/TimeWeaverGore/TimeWeaverGore4"), 1f);
