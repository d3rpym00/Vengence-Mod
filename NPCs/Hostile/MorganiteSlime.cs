...
{
    public class MorganiteSlime : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Morganite Slime");
        ...
        {
            Item.NewItem(npc.getRect(), ItemType<RefinedMorganite>(), 5);
        }
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            return spawnInfo.player.ZoneDirtLayerHeight ? 1.6f : 0f;
        }
