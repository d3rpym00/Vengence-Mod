...
namespace VengenceMod.Projectiles
{
	public class SpiritBringerProjectile : ModProjectile
    {
        ...
        {
            // makes it go slightly faster each tick
            ...
            Dust.VoidDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 15, projectile.velocity.X * -0.5f, projectile.velocity.Y * -0.5f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Main.PlaySound(SoundID.Item10, projectile.position); // impact sound at projectile location
        }
    }
}
