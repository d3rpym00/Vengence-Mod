...
namespace VengenceMod.Items
{
	...
	public class CosmicFury : ModItem
	{
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<CosmicBar>(), 17);
			recipe.AddIngredient(ModContent.ItemType<MysticWind>(), 1);
			recipe.AddIngredient(ModContent.ItemType<VortexianGreatbow>(), 1);
