...
namespace VengenceMod.NPCs.Passive
{
	/// <summary>
	...
	/// </summary>
	internal class VoidSnailNPC : ModNPC
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Void Snail");
		...
		public override void SetDefaults() {
			...
			npc.catchItem = (short)ItemType<VoidSnailItem>();
			npc.lavaImmune = true;
			//npc.aiStyle = 0;
	...
	internal class VoidSnailItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Void Snail");
		}
		...
		public override void SetDefaults() {
			...
			item.bait = 20;
			item.makeNPC = (short)NPCType<VoidSnailNPC>();
		}
	}
}
