...
{
	public class BloodshedClaymore : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Better than what i can do!.");  //The (English) text shown below your weapon's name
		}
